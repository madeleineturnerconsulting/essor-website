    ...
    <>
      ...
      <section className="grid md:grid-cols-[1.05fr_1fr] min-h-[760px]">
        ...
        <div className="px-14 pt-[100px] pb-[80px] flex flex-col justify-between">
          ...
          <div>
            <h1 className="font-serif font-light text-[clamp(52px,7vw,92px)] leading-none tracking-[-0.022em] mb-32">
              Your team<br />
              deserves to<br />
              <em className="italic text-accent">feel good</em><br />
              at work.
            </h1>
            <p className="font-sans text-[17px] leading-[1.65] text-ink-soft max-w-[460px] mb-32">
      ...
      <section className="px-14 py-[140px]">
        {/* Header row */}
        <div className="grid md:grid-cols-[1fr_2fr] gap-20 mb-28">
          <div>
            <div className="font-sans text-[10px] tracking-[0.18em] uppercase text-accent mb-8">
              At a glance
            </div>
            <h2 className="font-serif font-light text-[56px] leading-none tracking-[-0.02em] mb-16">
        ...
        <div className="border-t border-ink">
          {atAGlance.map(([label, value]) => (
            ...
            >
              <h3 className="font-serif text-[24px] font-light mb-6">{label}</h3>
      ...
      <section className="bg-paper-deep px-14 py-[120px]">
        <div className="text-center mb-[130px]">
          ...
          <h2 className="font-serif font-light text-[clamp(44px,5.6vw,72px)] leading-[1.05] tracking-[-0.02em] max-w-[900px] mx-auto mb-16">
        ...
        <div className="grid md:grid-cols-3">
          {caseItems.map(([title, desc], i) => {
            ...
            return (
              ...
              >
                <h3 className="font-serif text-[26px] font-light leading-[1.15] mb-14">
                  {title}
                </h3>
      ...
      <section className="px-14 py-[160px] grid md:grid-cols-2 gap-20 items-end">
        ...
        <div>
          <p className="font-sans text-[17px] leading-[1.65] text-ink-soft max-w-[480px] mb-40">
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <Link
              href="/how-it-works"
              className="inline-flex items-center gap-4 px-9 py-[28px] border border-ink text-ink font-sans text-[12px] tracking-[0.18em] uppercase rounded-full hover:bg-ink hover:text-white transition-colors"
            >
              See how it works
            </Link>
          </div>
